					...
					<div id="fcLeft">
						...
						<div class="detailHotelFc">
							<div>
								...
								<input type="checkBox" name="afaCamera" value="1"> <img
							...
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="afaAircon" value="1"> <img
							...
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="afaKitchen" value="1"> <img
							...
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="acWifi" value="1"> <img
							...
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="afaWasher" value="1"> <img
							...
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="afaParking" value="1"> <img
