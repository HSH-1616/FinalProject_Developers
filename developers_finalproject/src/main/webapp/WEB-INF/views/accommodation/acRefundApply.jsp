				...
				<div class="hotelPayInfo">
					...
					<div class="refundPayPrice">
						...
						<div class="resultPrice">
							...
							<c:if test="${nowRefund-checkIn<=3 && nowRefund-checkIn>1}">
								<h3>
									공제액(B) :
									<fmt:formatNumber value="${ra.apPrice*0.5}" pattern="#,###" />
								</h3>
								<h3>환불 가능 금액 : (A) - (B)</h3>
						</div>
						<hr />
						...
						<c:if test="${nowRefund-checkIn<=1 }">
							<h3>
								공제액(B) :
								<fmt:formatNumber value="${ra.apPrice*0.8}" pattern="#,###" />
							</h3>
							<h3>환불 가능 금액 : (A) - (B)</h3>
					</div>
					<hr />
					<h3>
						환불 가능 금액 :
						<fmt:formatNumber value="${ra.apPrice*0.2}" pattern="#,###" />
					</h3>
					</c:if>
