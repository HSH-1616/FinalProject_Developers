...
<script
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=737cdc9322ba7fec26566e0863b53498&libraries=services"></script>
...
<section>
	<div id="hotelRegistCon">
		...
		<div class="hotelRegist">
			...
			<div class="registDetailCon">
				<div class="registDetail">
					<div id="rdLeft">
						<h5>
						...
						<div class="registHotelType">
							...
							<div class="rt hotel">
								...
								<p class="rtTitle hotel">호텔</p>
							</div>
							<div class="rt motel">
								<input type="radio" name="acType" value="모텔">
								<div class="blurRt"></div>
								<img src="${path}/images/accommodation/moteldetail.png" alt="" />
								<p class="rtTitle motel">모텔</p>
							</div>
						</div>
						<table class="hotelCountTable">
							<tbody>
								<tr>
									<td><div class="hotelCountHeader">최대 인원</div></td>
									<td>
										<button type="button" class="hotelCountBtn people" id="minus">
									...
									<td><div class="hotelCountInfo people"></div></td>
								</tr>
								<tr>
									<td><div class="hotelCountHeader">방 개수</div></td>
									<td>
										<button type="button" class="hotelCountBtn room" id="minus">
											<ion-icon name="remove-circle-outline"></ion-icon>
										</button>
									...
									<td><div class="hotelCountInfo room"></div></td>
								</tr>
								<tr>
									<td><div class="hotelCountHeader">침대 개수</div></td>
									<td>
										<button type="button" class="hotelCountBtn bed" id="minus">
											<ion-icon name="remove-circle-outline"></ion-icon>
										</button>
									...
									<td><div class="hotelCountInfo bed"></div></td>
								</tr>
								<tr>
									<td><div class="hotelCountHeader">욕실 개수</div></td>
									<td>
										<button type="button" class="hotelCountBtn bathroom"
											id="minus">
											<ion-icon name="remove-circle-outline"></ion-icon>
										</button>
									...
									<td><div class="hotelCountInfo bathroom"></div></td>
								</tr>
							</tbody>
						</table>
					</div>
					<div id="rdRight">
						...
						<div>
							<div id="zipDiv">
								<input type="text" id="aaZip" placeholder="우편번호 찾기" readonly />
								<button type="button" onclick="kakaoAddress()">주소검색</button>
							</div>
							<div>
								<div id="addressDiv">
				...
				<div class="detailHotelFcCon">
					<div id="fcLeft">
						...
						<div class="detailHotelFc">
							<div>
								...
								<input type="checkBox" name="afaCamera" value="0"> <img
									...
									alt="" />
								<p class="fcTitle">보안 카메라</p>
							</div>
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="afaAircon" value="0"> <img
									...
									alt="" />
								<p class="fcTitle">에어컨</p>
							</div>
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="afaKitchen" value="0"> <img
									...
									alt="" />
								<p class="fcTitle">주방</p>
							</div>
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="afaWifi" value="0"> <img
									src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQt46MJ60DH3NWNy7YwarKPpPrZw_LPfQXklw&usqp=CAU"
									alt="" />
								<p class="fcTitle">무선 인터넷</p>
							</div>
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="afaWasher" value="0"> <img
									...
									alt="" />
								<p class="fcTitle">세탁기</p>
							</div>
							<div>
								<div class="blurFc"></div>
								<input type="checkBox" name="afaParking" value="0"> <img
					...
					<div id="fcRight">
						...
						<span id="insertFcWarn">편의시설 이미지와 이름을 추가해주세요.</span>
					</div>
				</div>
