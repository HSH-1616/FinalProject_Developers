...
<section>
	...
	<div class="foodDetailCon row">
		...
		<div class="row">
			<!-- 음식 슬라이드 -->
			<div class="food_slide col position-relative">
				<ul
					class="slides position-absolute top-50 start-50 translate-middle m-0 p-0 w-100 h-100">
					<input type="radio" name="radio-btn" id="img-1" checked />
					<li class="slide-container w-100 h-100">
						<div class="slide  w-100">
							<img lass="w-100" src="images/blacknoodle.jpg" />
						</div>
						<div class="nav w-25 h-100">
					...
					<li class="slide-container">
						<div class="slide">
							<img src="images/hambuger.jpg" />
						</div>
						<div class="nav">
							<label for="img-1" class="prev">&#x2039;</label> <label
								for="img-3" style="bottom: 350px;" class="next">&#x203a;</label>
						</div>
					</li>
					...
					<li class="slide-container">
						...
						<div class="nav">
							<label for="img-2" class="prev">&#x2039;</label> <label
								for="img-4" style="bottom: 350px;" class="next">&#x203a;</label>
						</div>
					</li>
					...
					<li class="slide-container">
						...
						<div class="nav">
							<label for="img-3" class="prev">&#x2039;</label> <label
								for="img-5" style="bottom: 350px;" class="next">&#x203a;</label>
						</div>
					</li>
					...
					<li class="slide-container">
						...
						<div class="nav">
							<label for="img-4" class="prev">&#x2039;</label> <label
								for="img-6" style="bottom: 350px;" class="next">&#x203a;</label>
						</div>
					</li>
					...
					<li class="slide-container">
						...
						<div class="nav">
							<label for="img-5" class="prev">&#x2039;</label> <label
								for="img-1" style="bottom: 350px;" class="next">&#x203a;</label>
						</div>
					</li>
