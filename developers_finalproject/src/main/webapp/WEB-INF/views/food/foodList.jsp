      ...
      <form class="low_theme">
        ...
        <div class="food_main_list">
          <div class="food_list">
            ...
            <img src="${path }/images/food/pork.jpg" width="300" height="300" alt="삼결살"/>
            <div class="food_place">엉터리삼겹살</div>
            <div class="food_name" style="color: #828282;">삼겹살</div>
            <img class="heart" src="${path }/images/food/fillheart.svg">
            <span class="heart_count">22</span>
          ...
          <div class="food_list">
            ...
            <img src="${path }/images/food/sushi.jpg" width="300" height="300" alt="초밥"/>
            <div class="food_place">연어상회</div>
            <div class="food_name" style="color: #828282;">연어초밥</div>
            <img class="heart" src="${path }/images/food/fillheart.svg">
            <span class="heart_count">22</span>
            <img class="comment" src="${path }/images/food/comment.png">
            <span class="comment_count">22</span>
          ...
          <div class="food_list">
            ...
            <img src="${path }/images/food/blacknoodle.jpg" width="300" height="300" alt="짜장면"/>
            <div class="food_place">홍콩반점</div>
            <div class="food_name" style="color: #828282;">짜장면</div>
            <img class="heart" src="${path }/images/food/fillheart.svg">
            <span class="heart_count">22</span>
            <img class="comment" src="${path }/images/food/comment.png">
            <span class="comment_count">22</span>
        ...
        <!-- 맛집 추가버튼 -->
        <div class="f_update">
            <button id="food_add" onclick="location.href='${path }/food/updateFood.do'">맛집 추가</button>
        </div>
        <!-- /맛집 추가버튼 -->
