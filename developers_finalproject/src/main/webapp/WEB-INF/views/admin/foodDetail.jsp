...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=4428a904f18357ee0a3f795c4918e96a&libraries=services,clusterer,drawing"></script>
<link rel="stylesheet"
...
<section>
	...
	<div class="foodDetailCon col justify-content-center">
		...
		<div class="row justify-content-center" style="height: 400px;">
			<form action="${path}/admin/updateFoodByFoodNo" method="get"
				class="row justify-content-center updateFoodReview"
				style="height: 400px; display: flex; flex-direction: column; /* align-content: space-between; */ justify-content: space-between; align-items: center;">
				<div
					class="foodInfosection d-flex flex-row justify-content-center align-items-center"
					style="height: 350px;">
					...
					<table class="text-start align-top food_info_table">
						<tr class="">
							...
							<td><textarea rows="4" cols="30" name="foodAddress"
									class="adminFoodAddress" style="border: none; resize: none;">${f.foodAddress}</textarea>
							</td>
						</tr>
						<tr>
							...
							<td><textarea rows="3" cols="40" name="foodMenu"
									class="adminFoodMenu" style="border: none; resize: none;">${f.foodMenu}</textarea>
							</td>
						</tr>
						<tr>
							...
							<td><input type="text" name="foodPhone" class="adminPhone"
								style="border: none;" value="${f.foodPhone }"></td>
						</tr>
					</table>
					<table class="text-start align-top food_info_table">
						<tr class="">
							...
							<td><textarea rows="4" cols="40" name="foodOpenTime"
									class="adminOpenTime" style="border: none; resize: none;">${f.foodOpenTime}</textarea>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="form-check form-switch">
									...
									<input class="form-check-input" type="checkbox" role="switch"
										name="allow" id="flexSwitchCheckChecked"
										${f.allow == 1?'checked':''} value="${f.allow}"
										onchange="YNCheck(event);"> <label
				...
				<button type="button" class="yoonBtn btnColorRed"
					style="width: 160px;" onclick="fn_updateCheck(event);">수정하기</button>
			</form>
		</div>
	</div>
