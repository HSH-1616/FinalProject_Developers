...
<jsp:include page="/WEB-INF/views/touris/tourisheader.jsp"/> 
      ...
      <div id="travellist-area">
        ...
        <c:forEach var="t" items="${tourislist }">
          <li class="selectlist2">
            <div class="listbox">
              <div class="listboximg"><img src="${t.tourismainImge }" alt=""></div>
    ...
    <div class="totalmodaldiv">
      <div class="modaldiv">
       ...
       <div class="modalflex">
         <img class="modalimage" src="https://www.myro.co.kr/getSpotImage/singapore?no=1003" alt="placephoto" id="locationInfoImage" loading="lazy">
