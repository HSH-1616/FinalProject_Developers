...
//				파싱할 객체 생성
					JsonObject obj2 = (JsonObject)JsonParser.parseString(commoncontent.toString()).getAsJsonObject();
...
//					 	여기서부터 파싱
//						파싱할 객체 생성
						JsonObject obj3 = (JsonObject)JsonParser.parseString(details.toString()).getAsJsonObject();
