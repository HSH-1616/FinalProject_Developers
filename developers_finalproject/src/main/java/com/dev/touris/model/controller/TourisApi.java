...
//
		 ...
		 String apiurl = "http://api.openweathermap.org/data/2.5/weather?q="+"SEOUL"+"&appid="+"28efd00f42dd0134f7e11ce21611ea86";

	        // Use your preferred method to make an HTTP request to the weather API
	        // and get the JSON response from the API.

	        // For example, using a library like RestTemplate:
