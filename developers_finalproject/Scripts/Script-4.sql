...
SELECT COUNT(*) FROM FOOD_PHOTO WHERE FP_NAME = 'http://tong.visitkorea.or.kr/cms/resource/06/2998506_image2_1.jpg';

INSERT INTO FOOD_TEMP SELECT * FROM FOOD WHERE FOOD_NO = 2788416;

SELECT * FROM food_photo WHERE FOOD_no = 2998578;
...
SELECT COUNT(*) FROM FOOD_PHOTO WHERE FP_NAME = 'http://tong.visitkorea.or.kr/cms/resource/01/2998501_image2_1.jpg';

SELECT * FROM FOOD WHERE FOOD_ALLOW = 0;
...
SELECT * FROM FOOD WHERE FOOD_NO = 2953130;
