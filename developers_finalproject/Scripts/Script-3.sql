...
SELECT * FROM FOOD_photo WHERE food_no = 2901530;
...
DELETE FROM FOOD_REVIEW WHERE FR_NO = 60;

UPDATE FOOD SET FOOD_ALLOW = 0 WHERE FOOD_NO = 2788416;

SELECT * FROM FOOD WHERE FOOD_ALLOW = 1;
SELECT COUNT(*) FROM FOOD WHERE FOOD_ALLOW = 0;
